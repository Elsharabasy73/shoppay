                ...
                <div className="relative z-10 w-full md:w-3/4 mx-auto">
                    <div className="flex flex-col lg:flex-row justify-between gap-8">
                        <div className="flex flex-col gap-2 items-center lg:items-start">
                            ...
                            <a href="https://maps.app.goo.gl/LKn1is733eKxzMfSA" target="_blank" rel="noreferrer" className="text-white/70 text-sm hover:text-white no-underline">Gamal Abd El-Nasser St, Assiut City, Assiut, Egypt</a>
                            <a href="tel:01026025804" className="text-white/70 text-sm hover:text-white no-underline">01026025804</a>
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-center mt-8 pt-6 border-t border-white/10 gap-4">
                        <div className="flex items-center gap-3">
                            ...
                            <a href="https://wa.me/201026025804" target="_blank" rel="noreferrer" aria-label="WhatsApp" title="Chat on WhatsApp 01026025804" className="w-8 h-8 rounded-full bg-[#25D366] flex items-center justify-center hover:bg-[#128C7E] transition no-underline text-white">
                            ...
                            <a href="tel:01026025804" className="text-white/60 text-sm ml-2 hover:text-white no-underline">01026025804</a>
                        </div>

    ...
    <div className="sigma-gradient text-white text-xs md:text-sm">
      <div className="max-w-[1400px] mx-auto px-5 lg:px-20 py-3 flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-3">
          <span aria-label="Facebook disabled" title="Facebook link disabled" className="w-7 h-7 rounded-full bg-white/60 flex items-center justify-center opacity-60 cursor-not-allowed pointer-events-none select-none">
            <svg className="w-3.5 h-3.5 fill-[#1877F2] opacity-60" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <span aria-label="Telegram disabled" title="Telegram link disabled" className="w-7 h-7 rounded-full bg-white/60 flex items-center justify-center opacity-60 cursor-not-allowed pointer-events-none select-none">
            <svg className="w-3.5 h-3.5 fill-[#229ED9] opacity-60" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <span aria-label="YouTube disabled" title="YouTube link disabled" className="w-7 h-7 rounded-full bg-white/60 flex items-center justify-center opacity-60 cursor-not-allowed pointer-events-none select-none">
            <svg className="w-3.5 h-3.5 fill-[#FF0000] opacity-60" viewBox="0 0 24 24" aria-hidden="true">
